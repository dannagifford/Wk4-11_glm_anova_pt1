...
Our first datafile is called ANOVA_lab1_data1.csv and can be found here:
...
Our second datafile is called ANOVA_lab1_data2.csv and can be found here:
...
Our third datafile is called ANOVA_lab1_data3.csv and can be found here:
