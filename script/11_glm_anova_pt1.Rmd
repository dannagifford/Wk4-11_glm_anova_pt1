...
We have `NA` for two conditions suggesting we have missing data somewhere in our dataset. 
We're going to use a new package now, called `visdat`. It allows us to visualise our dataset using the `vis_dat()` function and to visualise missing data using the `vis_miss()` function.
